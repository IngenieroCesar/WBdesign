				 ...
				 <div class="col-md-offset-3 col-md-6">
					 ...
					 <div class="box box-primary">
						 ...
						 <!-- form start -->
							...
							{!! Form::open(['route'=>['admin.users.update', $user], 'method' => 'PUT', 'name'=>'formulario_registro', 'files' => true ]) !!}

							 <div class="box-body">
								 <div class="form-group">
									 {!! Form::label('apellido', 'Apellido', ['required']) !!}
									 {!! Form::text('apellido', $user->apellido, ['class'=> 'form-control','id' => 'apellido', 'placeholder'=> ' Apellido ','required']) !!}
								 </div>
								 <div class="form-group">
							 		 {!! Form::label('name', 'Nombre', ['required']) !!}
									 {!! Form::text('name', $user->name,  ['class'=> 'form-control','id' => 'name', 'placeholder'=> ' Nombre ','required']) !!}
								 </div>
								 <div class="form-group">
									 {!! Form::label('cedula', 'Cedula' , ['required']) !!}
									 {!! Form::number('cedula', $user->cedula, ['class'=>'form-control','id' => 'cedula','placeholder'=>' Numero Cedula ', 'required']) !!}
								 </div>
								 <div class="form-group">
									{!! Form::label('email', 'Correo Electronico' , ['required']) !!}
									{!! Form::email('email', $user->email, ['class'=>'form-control', 'id' => 'email','placeholder'=>' Correo Electronico ', 'required']) !!}
								 </div>
					 <!--	 <div class="form-group">
							    ...
							    {!! Form::select('type', ['placeholder'=>'Tipo de Empleado...', 'administrador' => 'Administrador','administrador web' => 'Administrador Web','contador' => 'Contador', 'auxiliar contable' => 'Auxiliar Contable', 'empleado' => 'Empleado'], $user->type, [ 'class' => 'form-control select2' ])!!}
							  </div>
								<br>
								 <div class="form-group">
...
@section('js')
    ...
    <script>
        ...
        $("#input-23").fileinput({
            ...
            showRemove: true,
            initialPreview: [
                '<img src="/Imagenes/Users/{{ $user->imagen }}" class="file-preview-image" alt="The Moon" title="The Moon">',
            ],
