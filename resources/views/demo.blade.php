...
<div class="features" id="home">
		...
		<div class="row">
				...
				<div class="alldesc">
						...
						<h2>WBplataform Demo</h2>
					</div>
						<div class="col-md-6 col-sm-6 col-xs-12">
						<p class="desc">WBplataform esta desarrollado justo para ti. Es tú herramineta personal con la cual tendras el control de tú empresa desde tú dispositivo movil en cualquier lugar.</p>
					</div>
					</div>
			</div>
